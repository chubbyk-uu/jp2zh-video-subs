...
class QwenAsrConfig(BaseAsrConfig):
    ...
    whisperseg_max_speech: float = arg_field(5.0, help="WhisperSeg soft speech split target (s)")
    whisperseg_hard_max_speech: float = arg_field(8.0, help="WhisperSeg hard speech split cap (s; <= soft restores legacy cut)")
    whisperseg_soft_split_lookback: float = arg_field(1.0, help="WhisperSeg valley-search lookback before soft target (s)")
