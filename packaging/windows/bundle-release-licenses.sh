...
opencc_licenses="$licenses/opencc"
...
mkdir -p "$qt_licenses" "$model_licenses" "$opencc_licenses"
...
download https://raw.githubusercontent.com/BYVoid/OpenCC/ver.1.4.1/LICENSE "$opencc_licenses/LICENSE"
download https://raw.githubusercontent.com/BYVoid/OpenCC/ver.1.4.1/AUTHORS "$opencc_licenses/AUTHORS"
...
download https://huggingface.co/sugoitoolkit/Sugoi-14B-Ultra-GGUF/raw/main/README.md \
    "$model_licenses/sugoi-14b-ultra-README.md"
